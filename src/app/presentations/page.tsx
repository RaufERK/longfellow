export default function PresentationsPage() {
  return (
    <div className='container mx-auto px-4 py-8'>
      <h1 className='text-4xl font-bold text-center mb-8'>Презентации</h1>
        ...
        <div className='bg-white rounded-lg shadow-lg p-8'>
          <div className='mb-8'>
            ...
            <div className='prose prose-gray max-w-none'>
              <p className='text-gray-700 mb-4'>
                ...
                Каждая из чакр соответствует энергиям и качествам определённого
                космического луча. Этот луч объединяет энергии, качества, а
                также тех кто преуспел в овладении данным лучом или же
                изначально был создан для служения на нём.
              </p>
              ...
              <p className='text-gray-700 mb-4'>
                ...
                данное воплощение.{' '}
                <strong>
                  Этот луч определяет Ваше предназначение в этой жизни, основные
                  пути реализации и духовного роста.
                </strong>
              </p>
              ...
              <p className='text-gray-700 mb-6'>
                ...
                ключи, помогающие нам понять, каково наше предназначение, каков
                наш Путь, какие шаги как в обыденной жизни, так и в духовном
                плане мы можем предпринять для лучшего овладения семью лучами.
              </p>
          ...
          <div className='border-t border-gray-200 pt-6'>
            <p className='text-sm text-gray-600'>
              Если у вас возникли сложности с оформлением заказа через интернет,
              вы можете сделать заказ по телефонам{' '}
